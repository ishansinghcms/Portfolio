import betsolLogo from "../../../assets/betsol.png";
import freelancerLogo from "../../../assets/freelancer.png";
import icsolutionsLogo from "../../../assets/icsolutions.png";
...
export const experiences = {
  "Software Engineer": {
    ...
    logo: betsolLogo,
    experience: [
      `Utilized <span>MERN, React, Redux, Node, Express.js, JavaScript & TypeScript</span>.`,
      `Worked on 2 key products- <span>Zmanda</span>, a backup and recovery web application at Betsol and <span>Arise-Chat</span>, a chat application at Arise (External Client).`,
      `Worked on a <span>Launch Dashboard</span> for Zmanda which offered monitoring to various metrics like backup/restore jobs, storage, remaining time, logs and more.`,
      `<span>Optimized rendering efficiency</span> for Zmanda UI by minimizing unnecessary re-renders through techniques such as memoization and the use of callbacks. This lead to a remarkable <span>10%</span> improvement in code efficiency.`,
  ...
  Freelance: {
    ...
    experience: [
      ...
      `Delivered critical <span>bug fixes</span> and performed extensive <span>error debugging</span> for various web applications, significantly improving stability and user experience.`,
    ],
  },
  Internship: {
    ...
    position: "Intern",
    location: "Remote",
    logo: icsolutionsLogo,
    experience: [
      `Utilized <span>React, JavaScript & MongoDB.</span>.`,
      `Created <span>REST</span> APIs for the Admin Panel Web Application used for managing the Users and Partner details.`,
      `Utilized React to provide <span>real-time input validation feedback</span> for on UI Forms.`,
      `Worked on <span>MongoDB queries</span> responsible for updating and retrieving data in the database.`,
      `Gained exposure to the entire <span>Software Development Life Cycle (SDLC), Agile & DevOps practices</span> and <span>code quality standards</span>.`,
    ],
  },
};
